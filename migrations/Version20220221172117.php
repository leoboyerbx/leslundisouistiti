 ...
 */
final class Version20220221172117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD COLUMN title VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, date, seats FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date DATE NOT NULL, seats INTEGER NOT NULL)');
        $this->addSql('INSERT INTO event (id, date, seats) SELECT id, date, seats FROM __temp__event');
